...
func _change_state(state_name):
  ...
  # The Godot FSM example only ran this if the state_name wasn't "previous", which
  # doesn't make sense to me. You should want to re-enter the state at the top of
  # the stack
  current_state.enter()
